...
INPUT_FILE = os.path.join(base_dir, "input2.xlsx")
OUTPUT_FILE = os.path.join(base_dir, "output_with_lat_lon.xlsx")
CACHE_FILE = os.path.join(base_dir, "postcode_cache.pkl")
BATCH_SIZE = 100  # for Postcodes.io batch size
# ----------------------------------------------------
if not os.path.exists(INPUT_FILE):
    raise FileNotFoundError(
        f"Could not find '{INPUT_FILE}'.\n"
        f"Place input2.xlsx in:\n{base_dir}"
    )
# ---------------------- Load Data ----------------------
