...
input_file_path = os.path.join(base_dir, "latlonpairs.xlsx")
output_file_path = os.path.join(base_dir, "latlonpairsWDuration.xlsx")
# ------------------------------------------------------------
...
if not os.path.exists(input_file_path):
    raise FileNotFoundError(
        f"Could not find '{input_file_path}'.\n"
        f"Place latlonpairs.xlsx in:\n{base_dir}"
    )
#--------------------------------------------------------------
